...
"Menu Tiger Screens" klasorundeki 8 .h2d dosyasi, html.to.design eklentisinin sifreli yakalama formati. Yalnizca eklentinin kendisi acabilir; bu yuzden import elle yapilir (MCP/otomasyonla yapilamiyor).
...
4. `Menu Tiger Screens` klasorundeki .h2d dosyalarini surukleyip birak (veya dosya seciciyle sec). Her dosya, yakalandigi andaki sayfayi katmanlariyla birlikte frame olarak olusturur.
5. Once tek dosyayla dene (`www_app_menutigr_com_portal_1440w_1470w_default.h2d`); sorunsuzsa kalanlari al.

Notlar:
- Behance yakalamasi (12 MB) buyuk; import uzun surebilir.
